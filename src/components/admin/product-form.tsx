    ...
    <SelectContent>
      {brands.map((b) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <Label>{t("shortDescDe")}</Label>
            <Input
              value={form.shortDescDe}
              onChange={(e) => set("shortDescDe", e.target.value)}
              className="mt-1.5"
            />
          </div>
        </div>
      ...
      <div className="bg-white rounded-2xl border p-6 space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <Label>{t("seoTitleDe")}</Label>
            <Input
              value={form.seoTitleDe}
              onChange={(e) => set("seoTitleDe", e.target.value)}
              className="mt-1.5"
            />
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <Label>{t("seoDescDe")}</Label>
            <Textarea
              value={form.seoDescDe}
              onChange={(e) => set("seoDescDe", e.target.value)}
              className="mt-1.5"
              rows={2}
            />
          </div>
